...
$name = 'Создание скидки';
$submit_text = 'Создать';
$action = '/admin/discount/create/';
if (!empty($model->id)) {
    $submit_text = 'Сохранить';
    $name = 'Редактирование скидки';
    $action = '/admin/discount/edit/id/'.$model->id;
}

$this->breadcrumbs = array(
    'Home'=>$this->createUrl('/admin/'),
    'Скидки'=>Yii::app()->createUrl('/admin/discount/'),
    $name
);
...
<span class="admin-btn-wrapper">
    ...
    <div class="admin-btn-one">
        ...
        <?php echo CHtml::link('Удалить', '/admin/discount/delete/id/'.$model->id, array('class' => 'btn-admin')); ?>
    </div>
    <?php endif; ?>
    <div class="admin-btn-one">
        ...
        <div class="form wide wide-wrapper padding-all">
            <?php 
                ...
                $tabs=array(
                    ...
                    'Выбор товара' => $this->renderPartial('_product', array('model'=>$model,'form_view'=>$form_view), true)
                );
...
$(function(){
    ...
    $('#close-btn').click(function(){
        document.location.href = "<?php echo Yii::app()->getBaseUrl(true) ?>/admin/discount/";
    });
    
    editDiscount.initCalendar();
    
    $(".SidebarTabsControl a:last").click(function(){
        $('div#group').show();
    });
    
    $(".SidebarTabsControl a:first").click(function(){
        $('div#group').hide();
    });
