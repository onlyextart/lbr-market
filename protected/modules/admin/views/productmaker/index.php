...
<!--<span class="admin-btn-wrapper">
    <div class="admin-btn-one">
        ...
        <?php //echo CHtml::link('Создать производителя', '/admin/productmaker/create/', array('class' => 'btn-admin')); ?>
    </div>
</span>-->
<h1><?php echo $name; ?></h1>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array('id', 
            ...
            array(
                ...
                'buttons'=>array (
                    'update' => array (
                        'url'=>'Yii::app()->createUrl("admin/productmaker/edit", array("id"=>$data->id))',
                    ),
                    'delete' => array (
                        'url'=>'Yii::app()->createUrl("admin/productmaker/delete", array("id"=>$data->id))',
                        'click'=>'function(){
