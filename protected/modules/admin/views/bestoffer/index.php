...
<span class="admin-btn-wrapper">
    <div class="admin-btn-one">
        ...
        <?php echo CHtml::link('Создать', '/admin/bestoffer/create/', array('class' => 'btn-admin')); ?>
    </div>
</span>
<h1><?php echo $name; ?></h1>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'buttons'=>array (
                    'update' => array (
                        'url'=>'Yii::app()->createUrl("admin/bestoffer/edit", array("id"=>$data->id))',
                    ),
                    'delete' => array (
                        'url'=>'Yii::app()->createUrl("admin/bestoffer/delete", array("id"=>$data->id))',
                        'click'=>'function(){
