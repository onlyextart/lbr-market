...
if (!empty($model->id)) {
    ...
    $name = 'Редактирование филиала';
}
$this->breadcrumbs = array(
    'Home'=>$this->createUrl('/admin/'),
    'филиал'=>Yii::app()->createUrl(''),
    $name
);
...
<span class="admin-btn-wrapper">
    ...
    <div class="admin-btn-one">
        ...
        <?php echo CHtml::link('Удалить', '/admin/filial/delete/id/'.$model->id, array('class' => 'btn-admin')); ?>
    </div>
    <?php endif; ?>
...
$(function(){
    ...
    $('#close-btn').click(function(){
        document.location.href = "<?php echo Yii::app()->getBaseUrl(true) ?>/admin/filial/";
    });
    
    //$('#Category_path').prop("disabled", true);
