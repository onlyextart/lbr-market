<div id="aboutus-content">
    <h1 id="aboutus-header">Мы online</h1>
    <div id="aboutus-photos">
        <div class="aboutus-photo"><img src="/images/aboutus_1.jpg"></div>
        <div class="aboutus-photo"><img src="/images/aboutus_2.jpg"></div>
        <div class="aboutus-photo"><img src="/images/aboutus_3.jpg"></div>
    </div>
