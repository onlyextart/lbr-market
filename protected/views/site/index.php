...
<div id="shop-description">
    ...
    <div><span>Shop.lbr.ru </span>  – это электронный магазин запчастей для сельхозтехники, предоставляющий широкий ассортимент продукции (более 60 000 позиций от отечественных и импортных производителей). Вы всегда подберете здесь товар, который будет отличаться высоким качеством и приемлемой стоимостью.</div>
    ...
    <div>Магазин сельхоз запчастей стремится соответствовать требования каждого заказчика. Достаточно сделать заказ, а об остальном позаботимся мы. </div>
