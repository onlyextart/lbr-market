...
class PartnersController extends Controller
{
    public function actionIndex($path=null)
    {
        ...
        if(!empty($data_productmaker)||!empty($data_equipmentmaker)) $this->render('view_all', array('data_productmaker'=>$data_productmaker,'data_equipmentmaker'=>$data_equipmentmaker));
        else $this->redirect('/');
    }
