...
class Product extends CActiveRecord
{
	...
	public function rules()
	{
		...
		/*return array(
			array('product_group_id, product_maker_id, count, min_quantity', 'numerical', 'integerOnly'=>true),
			array('external_id, name, catalog_number, image, liquidity, additional_info, published', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, external_id, name, product_group_id, catalog_number, product_maker_id, image, count, liquidity, min_quantity, additional_info, published', 'safe', 'on'=>'search'),
		);*/
                return array(
			...
			array('external_id, name, product_group_id, catalog_number, product_maker_id, liquidity, image, additional_info, published', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
