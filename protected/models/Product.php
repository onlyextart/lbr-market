...
//            $maker_name
    ...
    public function attributeLabels() {
        ...
        return array(
            ...
            'maker_id'=>'',
            'maker_name'=>'Производитель техники'
        );
    }
    
    public function initForSale(){
        $products->filter_maker=array();
        $products->filter_category=array();
...
//        if(!empty($this->product_group_id)) {
//            $criteria->addCondition('t.product_group_id=:group_id');
//            $criteria->params[":group_id"] = $this->product_group_id;
//        }
